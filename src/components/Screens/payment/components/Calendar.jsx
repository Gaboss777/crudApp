...
const Calendar = ({client, year, user, payments, removePayment, createPayment}) => {
            ...
            {months.map(month => {
                ...
                return(
                    <Month title={month.name}>
                        ...
                        <InfoPayments month={month} user={user} payments={clientPayments} year={year} removePayment={removePayment} />
                        <Permission
                            role={user.role}
                            perform='payments:create'
                            yes={() =>
