    ...
    return (
        <Container fluid className='px-0 pb-4' >
            ...
            <Row>
                ...
                <Col sm lg={6}>
                    <ExpensesChart bills={bills} sells={sells} salaries={salaries} year={year} />
                </Col>
            </Row>
            <Row className='mt-3'>
                <Col sm lg={7} className='pr-0' >
                    <TableLastPayments list={list} payments={payments} year={year} />
                </Col>
                <Col sm lg={5}>
                    <TableLastExpenses sells={sells} salaries={salaries} bills={bills} year={year} />
                </Col>
            </Row>
            <Row className='mt-3'>
                <Col sm lg={3} >
