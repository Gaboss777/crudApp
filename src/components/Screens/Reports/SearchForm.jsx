                    ...
                    <Form.Row>
                        ...
                        <Form.Group as={Col} sm lg={3}>
                            ...
                            <Form.Control 
                                ...
                                disabled={tableData === '2' || tableData === '4' || tableData === '5' ? false : true} 
                                className={tableData === '2' || tableData === '4' || tableData === '5' ? '' : 'form-disable' }
                            >
                                <option value='' selected>Todo</option>
                                {tableData === '4' ? 
                                <>
                                ...
                                : tableData === '5' ?
                                <>
                                    <option disabled>-- Opciones Clientes --</option>
                                    <option value='mensualidad'>Mensualidad</option>
                                    <option value='alquiler'>Alquiler</option>
                                    <option value='mantenimiento'>Mantenimiento</option>
                                    <option value='instalacion'>Instalacion</option>
                                    <option value='otros'>Otros</option>
                                    <option disabled>-- Opciones Empleados --</option>
