...
const InfoPayment = ({month, sells, removeSell, clientsList, year, user}) => {
    ...
    return (
        <>
            <Button variant='dark' size='sm' onClick={() => setShow(true)} className='mr-2'>Ver Pagos</Button>
                                ...
                                return( 
                                    <tr>
                                        ...
                                        <td>
                                            <Permission
                                                role={user.role}
                                                perform='comission:remove'
                                                yes={() =>
                                                    <Button variant='danger' onClick={() => removeSell(p.id)} size='sm' >Eliminar</Button>
                                                }
                                            />
                                        </td>
                                    </tr>
